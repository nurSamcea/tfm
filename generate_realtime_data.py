#!/usr/bin/env python3
"""
Script para generar datos de sensores en tiempo real de forma continua.
Este script simula sensores reales enviando datos cada cierto intervalo.
"""
...
def generate_realtime_sensor_data(duration_minutes=None, interval_seconds=30, farmer_id=None):
...
def main():
    """Función principal."""
    parser = argparse.ArgumentParser(description='Generar datos de sensores en tiempo real')
